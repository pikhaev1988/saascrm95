...
Источник методологии: PDF «Рекомендации… ВПР», ФИОКО, 2026  
...
| DOCX PASS | 138 |
| Errors (sum) | 0 |
| Avg warnings / protocol | ~2.6 |
| Catalog COMPLETE | 135 |
| Catalog PARTIAL | 3 (ids 67, 139, 140) |
| Difficulty 0-mapped | 0 |
| Subjects | 13 |
| Classes | 4, 5, 6, 7, 8, 10 |
| Control Biology #11 | PASS (warnings=5, profile=SYSTEM_ANALYTICS, not changed) |
| Control English #6 | PASS (warnings=4) |

Warnings — методологические (выборка distribution/groups, journal/cross-year NOT_AVAILABLE и т.п.), **не** critical/error.
